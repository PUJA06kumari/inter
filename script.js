...
const products=[
  ...
  products.forEach(function(product)
  {
      ...
      summary.textContent="summary:"+product.description
      mainDiv.appendChild(productDiv)
      productDiv.append(name,no,image,category,summary)
      productDiv.classList.add('summary')
  }
  )
